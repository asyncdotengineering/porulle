      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Catalog Custom Fields", slug: "building/custom-fields" },
            ...
            { label: "Catalog Field Ownership", slug: "building/catalog-ownership" },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Entity Revisions", slug: "production/entity-revisions" },
            { label: "Upgrading", slug: "production/upgrading" },
