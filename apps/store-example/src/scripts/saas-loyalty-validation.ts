...
await kernel.services.organization.create({ id: "org_tea", name: "Tea Avenue", slug: "tea-avenue" });
await kernel.services.organization.create({ id: "org_coffee", name: "Bean & Brew", slug: "bean-and-brew" });
