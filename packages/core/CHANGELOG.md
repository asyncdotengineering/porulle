...
- [#150](https://github.com/asyncdotengineering/porulle/pull/150) [`e3b8102`](https://github.com/asyncdotengineering/porulle/commit/e3b8102d85b528546ff37aca4ef8de6f8c8ef03e) Thanks [@octalpixel](https://github.com/octalpixel)! - A converge now removes the tag, category and brand links the store dropped, and versions the entity when it does.
...
- [#148](https://github.com/asyncdotengineering/porulle/pull/148) [`4c140bc`](https://github.com/asyncdotengineering/porulle/commit/4c140bcdd82e8e3cc3957f629941f878b2e3a6a4) Thanks [@octalpixel](https://github.com/octalpixel)! - A change to an entity's links (category, brand, tag, media) moves `sellable_entities.updated_at` and fires `catalog.afterUpdate`, so a re-categorised or re-branded product re-indexes.
...
- [#147](https://github.com/asyncdotengineering/porulle/pull/147) [`01484a9`](https://github.com/asyncdotengineering/porulle/commit/01484a92d8d8be6b99350198a7eda0a5c5a392fb) Thanks [@octalpixel](https://github.com/octalpixel)! - Editing an entity's content moves `sellable_entities.updated_at`, so consumers that version a product from it see the edit.
...
- [#146](https://github.com/asyncdotengineering/porulle/pull/146) [`98b8547`](https://github.com/asyncdotengineering/porulle/commit/98b8547673c3cfded32562ec1a313958562d961e) Thanks [@octalpixel](https://github.com/octalpixel)! - The customer profile Porulle creates lazily now carries the shopper's email.
...
- [#142](https://github.com/asyncdotengineering/porulle/pull/142) [`579a00b`](https://github.com/asyncdotengineering/porulle/commit/579a00b46dc982aa6e0e5b3a5c9e4cce325e96e7) Thanks [@octalpixel](https://github.com/octalpixel)! - Variants get an `updated_at`, so a variant-only change leaves a trace a consumer can version from.
...
- [#141](https://github.com/asyncdotengineering/porulle/pull/141) [`54f215c`](https://github.com/asyncdotengineering/porulle/commit/54f215c3b833131c4378b54b8ab26c1b330ebef5) Thanks [@octalpixel](https://github.com/octalpixel)! - `catalog.importProducts` resolves the shared vocabulary (tags, categories, brands) in its own short transaction before the page transaction opens, not inside it.
...
- [#135](https://github.com/asyncdotengineering/porulle/pull/135) [`71ace6a`](https://github.com/asyncdotengineering/porulle/commit/71ace6a67d7dcae1602f2bbf6d91c97435a06ec8) Thanks [@octalpixel](https://github.com/octalpixel)! - Warn when an after-hook takes longer than 100ms.
...
- [#132](https://github.com/asyncdotengineering/porulle/pull/132) [`63d0562`](https://github.com/asyncdotengineering/porulle/commit/63d0562af8c12314509545a6c4379946b9629e6f) Thanks [@octalpixel](https://github.com/octalpixel)! - Fire `catalog.afterUpdate` when a custom-field proposal is approved.
...
- [#131](https://github.com/asyncdotengineering/porulle/pull/131) [`1e3ea65`](https://github.com/asyncdotengineering/porulle/commit/1e3ea6566ed1cd5dac9388af5511835d42e7f466) Thanks [@octalpixel](https://github.com/octalpixel)! - Forward the Better Auth options core was dropping, and stop the next one from being dropped silently.
...
- [#128](https://github.com/asyncdotengineering/porulle/pull/128) [`e9f1de6`](https://github.com/asyncdotengineering/porulle/commit/e9f1de6d18a35e706153c2e596799d35c00ffbc2) Thanks [@octalpixel](https://github.com/octalpixel)! - Confine fulfilment lookups and the tracking write to the caller's organization
...
- [#126](https://github.com/asyncdotengineering/porulle/pull/126) [`bc1ca17`](https://github.com/asyncdotengineering/porulle/commit/bc1ca17f168ef3c6bbad5eec2144cf4e5853b912) Thanks [@octalpixel](https://github.com/octalpixel)! - Give every 401 the `WWW-Authenticate` challenge RFC 9110 §15.5.2 requires
...
- [#122](https://github.com/asyncdotengineering/porulle/pull/122) [`f28bef1`](https://github.com/asyncdotengineering/porulle/commit/f28bef11a0ae73b1011aa29f7772d2c8fa6b05cd) Thanks [@octalpixel](https://github.com/octalpixel)! - A hook marked `inTransaction: true` is handed a context whose `db` IS the transaction.
...
- [#117](https://github.com/asyncdotengineering/porulle/pull/117) [`93715ed`](https://github.com/asyncdotengineering/porulle/commit/93715ededae7c8fb35f1d2c81637136e8a887501) Thanks [@octalpixel](https://github.com/octalpixel)! - Let a plugin declare that a hook must run inside the writing transaction.
  ...
  write a row that commits or rolls back _with_ the write it records was left
...
- [#116](https://github.com/asyncdotengineering/porulle/pull/116) [`217f9a6`](https://github.com/asyncdotengineering/porulle/commit/217f9a6f80630d66f50fa06a00322656bda9f61b) Thanks [@octalpixel](https://github.com/octalpixel)! - Run after-hooks after the transaction commits, not inside it.
...
- [#114](https://github.com/asyncdotengineering/porulle/pull/114) [`bc4328b`](https://github.com/asyncdotengineering/porulle/commit/bc4328badd48a76be1c31df349e881a2a66359be) Thanks [@octalpixel](https://github.com/octalpixel)! - Carry an optional `dateOfBirth` on the user model.
...
- [#108](https://github.com/asyncdotengineering/porulle/pull/108) [`687c7df`](https://github.com/asyncdotengineering/porulle/commit/687c7dfb546b023a9686b4af3ed446719b16b2fc) Thanks [@octalpixel](https://github.com/octalpixel)! - Scope a job's concurrency key to its task, so two tasks can share an entity id without sharing an exclusive slot.
  ...
  **Breaking: a concurrency key no longer excludes across task slugs.** Two jobs of different tasks
  ...
  _To migrate:_ if you relied on cross-task exclusion — deliberately giving two different tasks the
...
- [#107](https://github.com/asyncdotengineering/porulle/pull/107) [`8fd3716`](https://github.com/asyncdotengineering/porulle/commit/8fd3716a5fb5974c4a2b55f2d9a6bfecd6855a4a) Thanks [@octalpixel](https://github.com/octalpixel)! - An unauthorized order read no longer reveals that the order exists.
  ...
  **order number**, and order numbers come out of a sequence: short, ordered, and guessable by
  ...
  `authorizeOrderRead` refuses a stale cart secret with the _identical_ error as a wrong one, with a
  ...
  **What did not change.** A caller who may legitimately see the order still reads it: the owner, a
  ...
  assert their permission _before_ looking anything up — the note, timeline and refund sub-routes, via
